...
export const BlobsSvg = forwardRef<SVGSVGElement, BlobsSvgProps>(
  ({ blobColors, className, ...svgProps }, ref) => {
    const rectId = useId();
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Blob cx="260.5" cy="450.5" fill={blobColors[0]} />
...
export const BlobsBackground = forwardRef<HTMLDivElement, BlobsBackgroundProps>(
  ({ blobColors, children, className, ...divProps }, ref) => {
    return (
      <div className={cn('relative flex', className)} {...divProps} ref={ref}>
